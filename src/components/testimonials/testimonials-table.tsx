...
import { MoreHorizontalIcon, EditIcon, EyeIcon, EyeOffIcon, TrashIcon, UsersIcon, Star } from "lucide-react";
...
interface TestimonialsTableProps {
  ...
  onViewGroups: (testimonial: Testimonial) => void;
}
          ...
          {testimonials.length === 0 ? (
            ...
            testimonials.map((testimonial) => (
              ...
              >
                ...
                <TableCell>
                  <div className="text-sm text-muted-foreground">{formatDate(testimonial.createdAt)}</div>
                </TableCell>
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem onClick={() => onViewGroups(testimonial)}>
