...
import { testimonialCategories } from "@/data/testimonials";
...
export function TestimonialsFilters({ filters, onFiltersChange }: TestimonialsFiltersProps) {
  ...
  const hasActiveFilters = filters.categories.length > 0 || filters.rating !== null || filters.visibility !== "all";
