...
import { useSignup } from "../_hooks/mutations/use-signup";
...
export default function SignupPage() {
  ...
  const passwordLengthValid = password.length >= 6 || password === "";
              ...
              <div className="relative z-10">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 text-sm">
                    Sign up to access the CloudNow Admin Portal
                  </p>
                </div>
                ...
                >
                  ...
                  <div className="relative group">
                    ...
                    <Button
                      type="submit"
                      className="relative w-full bg-gradient-to-r from-[#005782] via-[#0a5a85] to-[#0d537b] hover:from-[#004a6f] hover:via-[#085170] hover:to-[#0b4a6b] text-white font-semibold py-6 text-base rounded-xl shadow-[0_4px_20px_rgba(0,87,130,0.4)] hover:shadow-[0_6px_30px_rgba(0,87,130,0.5)] transition-all duration-300 transform hover:scale-[1.02] border border-white/20 backdrop-blur-sm overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
                      disabled={
                        isLoading ||
                        !passwordsMatch ||
                        !passwordLengthValid ||
