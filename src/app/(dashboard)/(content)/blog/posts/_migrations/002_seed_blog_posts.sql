...
-- Insert sample blog posts based on blog.data.ts content

-- First, we need to create a default author (or use an existing user)
-- For seeding purposes, we'll use a placeholder author
DO $$
DECLARE
