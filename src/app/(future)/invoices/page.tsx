...
export default function InvoiceApprovalPage() {
  ...
  const filteredInvoices = invoices.filter((invoice) => {
    ...
    const matchesStaff = staffFilter === "all" || invoice.staffId === staffFilter;
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-600">{summary.unpaidInvoices}</p>
                </div>
                    ...
                    <TableRow key={invoice.id}>
                      ...
                      <TableCell>
                        <div>
                          ...
                          <div className="text-sm text-gray-500">{invoice.staffId}</div>
                        </div>
                      </TableCell>
                      <TableCell>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {summary.paidInvoices} paid invoices, {summary.unpaidInvoices} pending approval
                  </p>
                </div>
                <div className="text-right">
                  <div className="text-lg font-bold text-gray-900">{formatCurrency(summary.totalAmount)}</div>
                  <div className="text-sm text-gray-500">
                    Paid: {formatCurrency(summary.paidAmount)} | Unpaid: {formatCurrency(summary.unpaidAmount)}
                  </div>
                </div>
              </div>
            </CardContent>
      ...
      <Dialog open={isDetailOpen} onOpenChange={setIsDetailOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>Review invoice details and approve or reject payment.</DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter className="flex justify-between">
            <div className="flex gap-2">
              <Button variant="outline" onClick={() => selectedInvoice && handleExportInvoice(selectedInvoice)}>
                Export PDF
              </Button>
            </div>
            <div className="flex gap-2">
