...
export const config = {
  matcher: [
     ...
     * - __nextjs_original-stack-frame (Next.js error overlay source maps)
     * - favicon.ico (favicon file)
     * - public folder
     */
    "/((?!_next/static|_next/image|__nextjs_original-stack-frame|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)",
  ],
};
